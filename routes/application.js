const hs = require('../lib/hackhall-sendgrid');
...
exports.get = function (req, res, next) {
  req.db.User.findById(
    req.session.user._id,
    'firstName lastName photoUrl headline displayName angelUrl facebookUrl twitterUrl linkedinUrl githubUrl email isStripeToken stripeToken',
    {},
    function (err, user) {
      if (err) next(err);
